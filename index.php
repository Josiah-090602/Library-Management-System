          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td class="manage d-flex gap-2 justify-content-end">
                  <button class="btn btn-primary btn-sm editStudentBtn" id="<?php echo $student['studentId'];?>" ><i class="fa-regular fa-pen-to-square"></i>Update</button>
                  <button class="btn btn-danger btn-sm deleteStudentBtn" id="<?php echo $student['studentId'];?>" ><i class="fa-solid fa-trash mr-2"></i>Delete</button>
                </td>
              </tr>
              <?php endforeach; ?>
          </tbody>
...
<!-- Alert Modal -->
<div class="modal fade" id="PopAlert" tabindex="-1" aria-labelledby="addStudentLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
